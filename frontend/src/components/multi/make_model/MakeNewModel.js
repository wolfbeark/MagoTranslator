...
import MakeCustomModel from "./MakeCustomModel";
import MakeDefaultModel from "./MakeDefaultModel";
...
const BackBtnBox = styled(motion.div)`
  width: 10%;
  height: 10%;
  background-color: gray;
  position: absolute;
  ...
  align-items: center;
`;
const StartBtnBox = styled(motion.div)`
  width: 10%;
  height: 10%;
  background-color: gray;
  position: absolute;
...
export default React.memo(MakeNewModel);
