...
function SecondIChingExtraMake(props) {
  ...
  const onStartHandler = () => {
    ...
    tempMultiModel[CurrentModelNumber].SecondSpread[
      CurrentChildNumber
    ].SecondRanNumArr[CurrentSelectNum].push(leftNum);

    tempMultiModel[CurrentModelNumber].SecondSpread[
      CurrentChildNumber
    ].SecondRanNumArr[CurrentSelectNum].push(rightNum);
    ...
    tempMultiModel[CurrentModelNumber].SecondSpread[
      CurrentChildNumber
    ].extraCardCount[CurrentSelectNum] += 2;
    tempMultiModel[CurrentModelNumber].SecondSpread[
      CurrentChildNumber
    ].remainCardCount[CurrentSelectNum] += 2;
...
export default SecondIChingExtraMake;
